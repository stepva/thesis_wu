...
sentiment_ready = Path("reports") / "sentiment_ready_soc"
...
for i, company in enumerate(companies):
    ...
    for j, report in enumerate(reports):
        ...
        report_stats[company][report_name]["n_positive_words_soc"] = positive_count
        report_stats[company][report_name]["n_negative_words_soc"] = negative_count
...
with open(Path("reports") / "report_sentiment_words_soc.json", "w") as json_file:
