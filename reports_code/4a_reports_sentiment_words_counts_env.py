...
sentiment_ready = Path("reports") / "sentiment_ready_env"
...
for i, company in enumerate(companies):
    ...
    for j, report in enumerate(reports):
        ...
        report_stats[company][report_name]["n_positive_words_env"] = positive_count
        report_stats[company][report_name]["n_negative_words_env"] = negative_count
...
with open(Path("reports") / "report_sentiment_words_env.json", "w") as json_file:
