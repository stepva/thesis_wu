...
for i, company in enumerate(companies):
    ...
    for j, report in enumerate(reports):
        ...
        report_stats[company][report_name]["n_positive_words"] = positive_count
        report_stats[company][report_name]["n_negative_words"] = negative_count
...
with open(Path("reports") / "report_sentiment_words.json", "w") as json_file:
