...
sentiment_ready = news_folder / "sentiment_ready_gov"
...
with open(Path("news") / "news_sentiment_words_gov.json", "r") as json_file:
...
for i, company in enumerate(companies):
    ...
    for year in years:
        ...
        news_stats[company][year]["n_articles_processed_fy_gov"] = n_articles
        news_stats[company][year]["n_positive_words_fy_gov"] = positive_count
        news_stats[company][year]["n_negative_words_fy_gov"] = negative_count
...
with open(news_folder / "news_sentiment_words_gov.json", "w") as json_file:
