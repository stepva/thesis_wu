...
sentiment_ready = news_folder / "sentiment_ready_soc"
...
with open(Path("news") / "news_sentiment_words_soc.json", "r") as json_file:
...
for i, company in enumerate(companies):
    ...
    for year in years:
        ...
        news_stats[company][year]["n_articles_processed_fy_soc"] = n_articles
        news_stats[company][year]["n_positive_words_fy_soc"] = positive_count
        news_stats[company][year]["n_negative_words_fy_soc"] = negative_count
...
with open(news_folder / "news_sentiment_words_soc.json", "w") as json_file:
