...
sentiment_ready = news_folder / "sentiment_ready_env"
...
with open(Path("news") / "news_sentiment_words_env.json", "r") as json_file:
...
for i, company in enumerate(companies):
    ...
    for year in years:
        ...
        news_stats[company][year]["n_articles_processed_fy_env"] = n_articles
        news_stats[company][year]["n_positive_words_fy_env"] = positive_count
        news_stats[company][year]["n_negative_words_fy_env"] = negative_count
...
with open(news_folder / "news_sentiment_words_env.json", "w") as json_file:
